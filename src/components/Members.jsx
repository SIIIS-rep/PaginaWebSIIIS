...
const Members = () => {
    ...
    return (
        <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
            ...
            <div
                className="grid grid-cols-1 gap-4 w-full lg:w-6/12 lg:pt-8 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
                {dataUsers.map((user) => (
                    user.role === "member" && (
                        <div className="p-4 pb-6 text-center">
                            <img className="w-40 h-40 rounded-full mx-auto object-cover" src={user.profileImage}
                                 alt="featured Img"/>
