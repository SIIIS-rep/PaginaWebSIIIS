                    ...
                    <div className="flex flex-wrap">
                        <div className="w-5/6 sm:w-1/2 p-6">
                            ...
                            <p className="text-gray-600 mb-8">
                                Fomentar la investigación a jóvenes para ayudar a impulsar al desarrollo de ideas
                                innovadoras en
                                tecnología y transformación digital. Promoviendo un espacio autónomo de formación,
                                colaboración y
                                crecimiento, donde los participantes fortalecen sus capacidades mediante la
                                experimentación, la
                                capacitación constante y socialización de proyectos.
                                <br/>
                                <br/>
                                Imagen:
                                <a
                    ...
                    <div className="flex flex-wrap flex-col-reverse sm:flex-row">
                        ...
                        <div className="w-full sm:w-1/2 p-6 mt-6">
                            <div className="align-middle">
                                ...
                                <p className="text-gray-600 mb-8">
                                    Para 2030, consolidarse como un referente en innovación tecnológica y formación
                                    investigativa,
                                    liderando proyectos con impacto regional, nacional e internacional. Ser un espacio
                                    que fomente la
                                    curiosidad, el intercambio de ideas y el desarrollo de soluciones innovadoras frente
